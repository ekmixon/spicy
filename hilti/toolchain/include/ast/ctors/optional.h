...
public:
    ...
    Optional(Expression e, Meta m = Meta()) : NodeBase(nodes(type::Optional(type::Auto(m)), e), m) {}
    ...
    hilti::optional_ref<const Expression> value() const { return childs()[1].tryReferenceAs<Expression>(); }
